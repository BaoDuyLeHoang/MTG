...
const MaterialManagement = () => {
    ...
    const filteredMaterials = materialData.filter(material => {
        ...
        const matchesStatus = statusFilter === 'all' ? true :
                            statusFilter === 'active' ? material.status :
                            !material.status;
                            ...
                            <tbody>
                                {currentItems.map((material) => (
                                    <tr key={material.materialId}>
                                        ...
                                        <td>
                                            <span className={`status ${material.status ? 'status-green' : 'status-red'}`}>
                                        ...
                                        <td>
                                            <div className="table-actions">
                                                <button 
                                                    ...
                                                    onClick={() => handleAction(material.materialId, material.status)}
