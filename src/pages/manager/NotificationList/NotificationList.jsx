...
import { getMyNotifications, getNotificationDetail, getNotificationDetailForManager } from '../../../services/notification';
...
const NotificationList = () => {
  ...
  const handleNotificationClick = async (notificationId) => {
    try {
      const detail = await getNotificationDetailForManager(notificationId); // Gọi API để lấy chi tiết thông báo
